...
import SiderMenu from '../../SubMenu2';
import { usesidebarStateQuery as useSidebarStateQuery, usetoggleSidebarMutation as useToggleSidebarMutation } from '../../generated';
...
export function SidebarComponent({
  ...
  const [ toggleSidebarState ] = useToggleSidebarMutation();
  ...
  return (
   <>
    <SiderMenu
      ...
      // styles={{} as any}
      // location={location}
      // collapsed={data.sidebarState}
      // onCollapse={toggleSidebarState}
      // user={user}
    />
   </>
  );
