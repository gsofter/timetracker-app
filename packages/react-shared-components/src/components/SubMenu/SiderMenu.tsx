...
export default class SiderMenu extends React.PureComponent<ISiderMenu.Props, ISiderMenu.State> {
    ...
    private handleOpenChange = openKeys => {
        ...
        const moreThanOne = filter(openKeys, openKey => this.isMainMenu(openKey)).length > 1;
        this.setState({
        ...
        return (
            ...
            >
                ...
                <div className={styles.sider}>
                    ...
                    >
                        {this.getNavMenuItems(filter(this.menus, menu => menu.position === IMenuPosition.MIDDLE))}
                    </Menu>
                ...
                <Menu
                    ...
                    style={{ padding: '16px 0', width: '100%' }}
                >
                    {this.getNavMenuItems(filter(this.menus, menu => menu.position === IMenuPosition.BOTTOM))}
                </Menu>
            </Sider>
        );
    }
