...
export type Action =
  ...
  | ({ type: '@@admin-layout/LOAD_COUNT_SUCCESS' } & QEmpty & S<{ value: number }>)
...
const _saveCount: ApiActionGroup<{ value: number }, {}> = {
  request: (request) =>
    ({ type: '@@admin-layout/SAVE_COUNT_REQUEST', request }),
  success: (response, request) =>
    ({ type: '@@admin-layout/SAVE_COUNT_SUCCESS', request, response }),
  error: (error, request) =>
    ({ type: '@@admin-layout/SAVE_COUNT_ERROR', request, error }),
};

const _loadCount: ApiActionGroup<null, { value: number }> = {
  request: (request) =>
    ({ type: '@@admin-layout/LOAD_COUNT_REQUEST', request: null }),
  success: (response, request) =>
    ({ type: '@@admin-layout/LOAD_COUNT_SUCCESS', request: null, response }),
  error: (error, request) =>
    ({ type: '@@admin-layout/LOAD_COUNT_ERROR', request: null, error }),
};
