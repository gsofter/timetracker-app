    ...
    siderMenuStyles: ({ theme }) => {
        ...
        return {
            ...
            '& .ant-drawer-close': {
                top: '-13px',
                right: '-17px',
                color: themeName === 'light' ? primaryColor : '#fff', // @sri modified
            },
            '& .ant-drawer-content': {
                backgroundColor: themeName === 'light' ? '#000' : '#fff', // @sri modified
            },
            '& .ant-pro-sider.ant-layout-sider-light .ant-menu-item a': {

            },
            '& .ant-menu-submenu-selected, .ant-menu-submenu-title:hover, .ant-menu-submenu-title i:hover ': {
            ...
            '& .ant-divider': {
                color: themeName === 'light' ? 'rgba(0, 0, 0, 0.50)' : 'rgba(255, 255, 255, 0.65)', // @sri modified
                borderTopColor: themeName === 'light' ? 'rgba(0, 0, 0, 0.50)' : 'rgba(255, 255, 255, 0.65)', // @sri modified
            },
