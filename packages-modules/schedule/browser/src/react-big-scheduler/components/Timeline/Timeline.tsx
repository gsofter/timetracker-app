...
function TimelineCalendar({ handleAddSchedule, events: propEvents }: ITimelineCalendarProps) {
    ...
    const [visibleTimeStart, setVisibleTimeStart] = useState(moment().startOf('week').add(1, 'day').valueOf())
    const [visibleTimeEnd, setVisibleTimeEnd] = useState(moment().startOf('week').add(1, 'week').add(1, 'day').valueOf())
    const onClickPrev = () => {
